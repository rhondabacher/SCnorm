...
SCnorm is an R package which can be used to normalize single-cell RNA-seq data. Version 0.99.7 of SCnorm is now accepted to Bioconductor and instructions for download may be found at [https://bioconductor.org/packages/devel/bioc/html/SCnorm.html](https://bioconductor.org/packages/devel/bioc/html/SCnorm.html).
...
Make sure to use the latest version of SCnorm by installing it from BioConductor or GitHub. You will need to use the development version of Bioconductor to install.

```R
source("https://bioconductor.org/biocLite.R")
useDevel() # To use development version
biocLite("SCnorm")
```
or
...
## Latest Update: v0.99.7
SCnorm has been accepted for Bioconductor submission -- please see vignette for complete updates and updated function usage. 
