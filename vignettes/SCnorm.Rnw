...
checkCountDepth(Data = ExampleData, Conditions = Conditions, 
                ...
                FilterCellProportion = .1, NCores=2)
@
...
checkCountDepth(Data = bulkH1data, Condition = Conditions, 
                OutputName = "check_bulkData", 
                FilterCellProportion = .1, 
                FilterExpression = 2, NCores=2)
@
...
\begin{figure}[h!]
\centering
\includegraphics[width=.7\textwidth]{check_bulkData_count-depth_evaluation.pdf}
...
checkCountDepth(Data = scH1data, Condition = Conditions, 
                OutputName = "check_scData", 
                FilterCellProportion = .1, 
                FilterExpression = 2, NCores=2)
...
\begin{figure}[h!]
\centering
\includegraphics[width=.7\textwidth]{check_scData_count-depth_evaluation.pdf}
\caption{Evaluation of count-depth relationship in un-normalized H1 single 
  cell data.}
\end{figure}
